...
class ActionSearchRestaurants(Action):
	...
	def run(self, dispatcher, tracker, domain):
		try:
			...
			config={ "user_key":"4ab20ddcffea88aa53c396a520f79545"}
...
class ActionSendEmail(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		try:
			...
			gmail_user = 'foodappakskgypp@gmail.com'
			gmail_password = 'Happy_2019'

			sender_addr = "gmail_user"
			to_addr = [str(recipient_email)]
			#to_addr = ['allmybill2017@gmail.com','grylearn@gmail.com','puneetpandey10@gmail.com','jsaikmr@gmail.com']
			#to_addr = ['jsaikmr@gmail.com']
